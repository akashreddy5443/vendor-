            ...
            <div className="group relative flex flex-col overflow-hidden rounded-xl border border-blue-900/30 bg-card text-card-foreground transition-all duration-300 shadow-lg shadow-purple-900/20 hover:scale-[1.02] hover:border-purple-500/50 hover:shadow-2xl hover:shadow-purple-500/40">
                ...
                <div className="aspect-square bg-black/40 relative overflow-hidden flex items-center justify-center">
                    ...
                    <div className="absolute top-2 right-2 z-30 flex flex-col gap-2 opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300">
                        <div className="bg-black/40 backdrop-blur-md rounded-full p-1.5 hover:bg-black/80 transition-colors pointer-events-auto border border-white/10 shadow-lg">
                            <WishlistToggle productId={product.id} className="text-white hover:text-red-500" />
                        </div>
                        <div className="bg-black/40 backdrop-blur-md rounded-full p-1.5 hover:bg-black/80 transition-colors pointer-events-auto border border-white/10 shadow-lg">
                            <CompareToggle productId={product.id} className="text-white hover:text-cyan-400" />
                        </div>
                        <button
                            onClick={(e) => {
                                e.preventDefault()
                            ...
                            className="bg-black/40 backdrop-blur-md rounded-full p-2 text-white hover:bg-black/80 transition-colors hover:text-orange-400 border border-white/10 shadow-lg"
                            title="Quick View"
                        >
                        ...
                        <button
                            ...
                            className={`bg-black/40 backdrop-blur-md rounded-full p-2 text-white hover:bg-black/80 transition-colors hover:text-green-400 border border-white/10 shadow-lg ${isOutOfStock ? 'opacity-50 cursor-not-allowed hidden' : ''}`}
                            title="Add to Cart"
                        >
