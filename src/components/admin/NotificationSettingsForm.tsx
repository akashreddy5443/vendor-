                ...
                {activeTab === 'toggles' && (
                    <div className="space-y-6">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <p className="text-sm text-gray-400">Control which notifications users can toggle in their settings.</p>
                        </div>

                        <div className="grid gap-4">
                            {settings.map((setting) => (
                                <div key={setting.key} className="flex items-center justify-between p-4 bg-gray-950 rounded-lg border border-gray-800 hover:border-gray-700 transition-colors">
