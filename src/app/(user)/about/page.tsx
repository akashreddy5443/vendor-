...
// Hardcoded Premium Data - No SQL Required
const ABOUT_DATA = {
    ...
    profile: {
        ...
        imageUrl: "" // Can be replaced with actual image URL later
    }
}
            ...
            <div className="min-h-[80vh] flex flex-col items-center justify-center text-center space-y-16 py-20 animate-in fade-in duration-700 px-6">
                ...
                <div className="space-y-6 max-w-4xl mx-auto">
                    <h1 className="text-4xl md:text-6xl font-black tracking-tight text-white mb-4">
                        About <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-600">TechDeveloper17</span>
                    </h1>
                    <p className="text-xl md:text-2xl text-gray-400 font-light">
                        {ABOUT_DATA.pageSubtitle}
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-12 w-full max-w-6xl mx-auto items-center text-left">
                    ...
                    {/* Left: Text */}
                    <div className="space-y-8 p-8 rounded-3xl bg-zinc-900/50 border border-zinc-800 backdrop-blur-sm hover:border-blue-500/30 transition-colors duration-500">
                        <h2 className="text-3xl font-bold text-white">{ABOUT_DATA.missionTitle}</h2>
                        <p className="text-gray-400 leading-relaxed text-lg">
                            {ABOUT_DATA.missionDescription}
                        </p>

                        <div className="grid grid-cols-2 gap-6 pt-4">
                            {ABOUT_DATA.stats.map((stat, i) => (
                                <div key={i} className="p-4 rounded-2xl bg-black/40 border border-zinc-800">
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative bg-zinc-950 border border-zinc-800 rounded-[2.5rem] p-10 text-center space-y-6 overflow-hidden">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-white">{ABOUT_DATA.profile.name}</h3>
                                <p className="text-blue-400 font-medium">{ABOUT_DATA.profile.role}</p>
                            </div>
                            ...
                            <div className="flex justify-center gap-4 pt-2">
                                <button className="p-2 rounded-full bg-zinc-900 text-white hover:bg-blue-600 transition-colors">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" /></svg>
                                </button>
                                <button className="p-2 rounded-full bg-zinc-900 text-white hover:bg-pink-600 transition-colors">
                                ...
                                <button className="p-2 rounded-full bg-zinc-900 text-white hover:bg-red-600 transition-colors">
