...
export default async function AboutPage() {
    ...
    // Fetch settings from homepage_sections
    ...
    // Fallback data if DB is empty (shouldn't happen after migration)
    const data = section?.content_json || {
        pageTitle: "About TechDev",
        pageSubtitle: "Helping Brands Grow with Content",
        missionTitle: "Tech-Driven Brand Growth",
        missionDescription: "Empowering brands...",
        profile: { name: "TechDeveloper", role: "Admin", bio: "..." }
    }
                ...
                <div className="grid md:grid-cols-2 gap-12 w-full max-w-6xl mx-auto items-center text-left">
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative bg-zinc-950 border border-zinc-800 rounded-[2.5rem] p-10 text-center space-y-6 overflow-hidden">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-white">{data.profile?.name}</h3>
