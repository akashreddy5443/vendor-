            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                    ...
                    >
                        {({ open }) => (
                            <button
                                type="button"
                                onClick={() => open()}
                                className="flex items-center gap-2 rounded bg-blue-600 px-4 py-2 font-bold text-white transition-colors hover:bg-blue-700 shadow-sm"
                            >
                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4 lg:grid-cols-6">
                    {uploadedImages.length === 0 && (
                        <div className="col-span-full py-10 text-center text-gray-500 border border-dashed border-gray-300 rounded-lg bg-gray-50">
